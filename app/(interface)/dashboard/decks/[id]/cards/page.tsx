    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (deckResponse.ownerId !== user?.id) {
          showToast("Access Denied", "You can only manage cards for your own decks.", "error");
        ...
        showToast("Error", "Failed to load deck or cards. Please try again.", "error");
        router.push("/dashboard/decks");
      } finally {
        setIsLoading(false);
      }
  ...
  return (
    ...
    >
      <Box position="relative" zIndex={3}>
        ...
        {cards.length === 0 ? (
          <ChakraText color="gray.300">No cards found. Add a new card to get started.</ChakraText>
        ) : (
          <Table variant="simple">
            <Thead>
              <Tr borderBottom="2px solid" borderColor="blue.900">
                <Th color="gray.400" textTransform="uppercase">Front</Th>
                <Th color="gray.400" textTransform="uppercase">Back</Th>
                <Th color="gray.400" textTransform="uppercase">Skill</Th>
                <Th color="gray.400" textTransform="uppercase">Actions</Th>
              </Tr>
            </Thead>
            <Tbody>
              {cards.map((card) => (
                ...
                <VStack spacing={4}>
                  ...
                  <FormControl isRequired>
                    ...
                    <Select
                      ...
                      _focus={{ borderColor: "blue.700", boxShadow: "0 0 5px rgba(66, 153, 225, 0.3)" }}
                    >
                      <option value="Reading" style={{ backgroundColor: "#1A202C", color: "white" }}>
                        Reading
                      </option>
                      <option value="Writing" style={{ backgroundColor: "#1A202C", color: "white" }}>
                        Writing
                      </option>
                      <option value="Speaking" style={{ backgroundColor: "#1A202C", color: "white" }}>
                        Speaking
                      </option>
                      <option value="Listening" style={{ backgroundColor: "#1A202C", color: "white" }}>
                        Listening
                      </option>
                    </Select>
                  </FormControl>
